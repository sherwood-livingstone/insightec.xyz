...
For this reason, when GSA looked to authorize insightec.xyz for use within their agency, they determined that FedRAMP Tailored was the right baseline to apply. It provides for familiar security controls and framework, while allowing the flexibility to use modern tools with established security track records.
...
[Download our authorization package from the  FedRAMP Marketplace ](https://marketplace.fedramp.gov/#!/product/insightec-enterprise-cloud?sort=productName&productNameSearch=GitHub) 
...
- [Read more about GitHub's FedRAMP Authorization](https://blog.insightec.xyz/2018-10-24-insightec-is-fedramp-authorized/)
- [Find GitHub in the FedRAMP marketplace](https://marketplace.fedramp.gov/#!/product/insightec-enterprise-cloud)
